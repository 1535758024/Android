...
public class MainActivityTest {
    ...
    public void mainActivityTest() {
        ...
        ViewInteraction materialTextView = onView(
                allOf(withId(android.R.id.title), withText("添加1"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.edittext_item_name), withText("Name"),
                        childAtPosition(
                                ...
                                1),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("book"));

        ViewInteraction appCompatEditText2 = onView(
                allOf(withId(R.id.edittext_item_name), withText("book"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
        ...
        ViewInteraction materialButton = onView(
                allOf(withId(R.id.button_item_detailsOk), withText("ok"),
                        childAtPosition(
                                childAtPosition(
                                        withId(android.R.id.content),
                                        0),
